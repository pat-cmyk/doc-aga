...
interface QueueItem {
  ...
  payload: {
    ...
    // Single weight recording (from animal profile)
    singleWeight?: {
      animalId: string;
      animalName: string | null;
      weightKg: number;
    ...
    // Barn operations (offline barn management)
    barnData?: { name: string; barn_type: string; description?: string | null; capacity?: number | null };
    barnId?: string;
