...
const CACHE_DEPENDENCIES: Record<string, string[]> = {
  ...
  'animal': ['animals', 'dashboard', 'milk-inventory', 'lactating-animals', 'herd-valuation-unified', 'breeding-analytics', 'breeding-hub'],
  'ai-record': ['ai-records', 'dashboard', 'breeding-stats', 'heat-records', 'upcoming-alerts', 'breeding-analytics', 'breeding-hub'],
  ...
  'heat-record': ['heat-records', 'dashboard', 'breeding-stats', 'breeding-analytics', 'breeding-hub'],
  ...
  'pregnancy-confirm': ['ai-records', 'breeding-stats', 'animals', 'dashboard', 'upcoming-alerts', 'breeding-analytics', 'breeding-hub'],
