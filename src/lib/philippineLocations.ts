// Philippine Location Hierarchy Data
...
export const PHILIPPINE_LOCATIONS: LocationHierarchy = {
  ...
  "Region IX": {
    "Zamboanga del Norte": ["Bacungan", "Baliguian", "Dapitan City", "Dipolog City", "Godod", "Gutalac", "Jose Dalman", "Kalawit", "Katipunan", "La Libertad", "Labason", "Liloy", "Manukan", "Mutia", "Piñan", "Polanco", "President Manuel A. Roxas", "Rizal", "Salug", "Sergio Osmeña Sr.", "Siayan", "Sibuco", "Sibutad", "Sindangan", "Siocon", "Sirawai", "Tampilisan"],
  ...
  "BARMM": {
    ...
    "Lanao del Sur": ["Bacolod-Kalawi", "Balabagan", "Balindong", "Bayang", "Binidayan", "Buadiposo-Buntong", "Bubong", "Butig", "Calanogas", "Ditsaan-Ramain", "Ganassi", "Kapai", "Kapatagan", "Lumba-Bayabao", "Lumbaca-Unayan", "Lumbatan", "Lumbayanague", "Madalum", "Madamba", "Malabang", "Marantao", "Marawi City", "Marogong", "Masiu", "Mulondo", "Pagayawan", "Piagapo", "Picong", "Poona Bayabao", "Pualas", "Saguiaran", "Sultan Dumalondong", "Tagoloan II", "Tamparan", "Taraka", "Tubaran", "Tugaya", "Wao"],
    "Maguindanao del Norte": ["Barira", "Buldon", "Datu Blah T. Sinsuat", "Datu Odin Sinsuat", "Kabuntalan", "Matanog", "Northern Kabuntalan", "Parang", "Sultan Kudarat", "Sultan Mastura", "Talitay"],
...
export const getRegions = (): string[] => {
  return Object.keys(PHILIPPINE_LOCATIONS);
};

// Helper function to get provinces for a region
export const getProvinces = (region: string): string[] => {
  return Object.keys(PHILIPPINE_LOCATIONS[region] || {});
};

// Helper function to get municipalities for a province
export const getMunicipalities = (region: string, province: string): string[] => {
  return PHILIPPINE_LOCATIONS[region]?.[province] || [];
};
