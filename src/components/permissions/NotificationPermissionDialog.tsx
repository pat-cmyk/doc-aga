    ...
    if (isCapacitor && isIOS) {
      return (
        <ol className="list-decimal list-inside space-y-2 text-sm text-muted-foreground">
          ...
          <li>Choose your preferred alert style</li>
          <li>Return to Doc Aga and tap <strong>"Try Again"</strong></li>
        </ol>
      );
    }
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <div className="flex items-center gap-3">
            ...
            <DialogTitle className="text-xl">Notification Permission Needed</DialogTitle>
          </div>
          <DialogDescription className="pt-4 space-y-4">
            <p>
              Doc Aga needs notification access for:
            </p>
            <ul className="list-disc list-inside space-y-1 text-sm">
              <li>Sync status alerts when offline data uploads</li>
              <li>Vaccination and deworming reminders</li>
              <li>Breeding schedule notifications</li>
              <li>Government feedback responses</li>
            </ul>
          </DialogDescription>
        </DialogHeader>
