...
import { MapPin, Settings, ExternalLink, RefreshCw } from "lucide-react";
  ...
  const getPlatformInstructions = () => {
    if (isCapacitor && isAndroid) {
      return (
        <ol className="list-decimal list-inside space-y-2 text-sm text-muted-foreground">
          ...
          <li>Select <strong>"Allow"</strong> or <strong>"While using the app"</strong></li>
    ...
    if (isCapacitor && isIOS) {
      return (
        <ol className="list-decimal list-inside space-y-2 text-sm text-muted-foreground">
          <li>Tap <strong>"Open Settings"</strong> below</li>
          <li>Scroll down to find <strong>"Location"</strong></li>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <div className="flex items-center gap-3">
            ...
            <DialogTitle className="text-xl">Location Permission Needed</DialogTitle>
          </div>
          <DialogDescription className="pt-4 space-y-4">
            <p>
              Doc Aga needs location access for:
            </p>
            <ul className="list-disc list-inside space-y-1 text-sm">
              <li>Accurate farm location for government reporting</li>
              <li>Finding nearby distributors and suppliers</li>
              <li>Regional weather and market data</li>
            </ul>
          </DialogDescription>
        </DialogHeader>
