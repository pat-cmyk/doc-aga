...
const SOURCE_COLORS: Record<string, string> = {
  farmer_sale: "bg-green-100 text-green-800",
  farmer_input: "bg-blue-100 text-blue-800",
  regional_aggregate: "bg-purple-100 text-purple-800",
  da_bulletin: "bg-orange-100 text-orange-800",
  system_default: "bg-gray-100 text-gray-800",
};
