...
function getFarmerTools(): any[] {
  return [
    ...
    { type: "function", function: { name: "update_health_record", description: "Update/correct an existing health record. Use when farmer says a previous diagnosis was wrong or needs correction. Can update diagnosis, treatment, or add notes.", parameters: { type: "object", properties: { animal_identifier: { type: "string", description: "Animal name or ear tag" }, record_date: { type: "string", description: "Optional: specific date (YYYY-MM-DD) to target. Defaults to most recent." }, new_diagnosis: { type: "string", description: "Corrected diagnosis" }, new_treatment: { type: "string", description: "Updated treatment" }, additional_notes: { type: "string", description: "Additional notes about the correction" } }, required: ["animal_identifier"] } } },
    { type: "function", function: { name: "add_health_resolution", description: "Mark a health issue as resolved. Add resolution notes to close out a health record. Use when farmer reports an issue has healed or subsided.", parameters: { type: "object", properties: { animal_identifier: { type: "string", description: "Animal name or ear tag" }, diagnosis: { type: "string", description: "Optional: target specific diagnosis to resolve" }, resolution_notes: { type: "string", description: "How the issue was resolved (e.g., 'Subsided after 2 days', 'Treated successfully with antibiotics')" } }, required: ["animal_identifier", "resolution_notes"] } } },
    // Weight tools
    { type: "function", function: { name: "add_weight_record", description: "Record a weight measurement for an animal. Use when farmer reports a weight (e.g., '350kg si Bessie'). Critical for growth tracking.", parameters: { type: "object", properties: { animal_identifier: { type: "string", description: "Animal name or ear tag" }, weight_kg: { type: "number", description: "Weight in kilograms" }, measurement_method: { type: "string", description: "Optional: scale, tape_measure, visual_estimate" }, notes: { type: "string", description: "Optional: additional observations" } }, required: ["animal_identifier", "weight_kg"] } } },
    { type: "function", function: { name: "update_weight_record", description: "Correct a previous weight record. Use when farmer says a weight was recorded wrong (e.g., 'mali yung 350kg, 340kg lang pala').", parameters: { type: "object", properties: { animal_identifier: { type: "string", description: "Animal name or ear tag" }, record_date: { type: "string", description: "Optional: specific date (YYYY-MM-DD) to target. Defaults to most recent." }, new_weight_kg: { type: "number", description: "Corrected weight in kg" }, notes: { type: "string", description: "Reason for correction" } }, required: ["animal_identifier"] } } },
    // Milking update tool
    { type: "function", function: { name: "update_milking_record", description: "Correct a previous milking record. Use when farmer says liters were recorded wrong (e.g., 'mali yung 5L, 8L pala').", parameters: { type: "object", properties: { animal_identifier: { type: "string", description: "Animal name or ear tag" }, record_date: { type: "string", description: "Optional: specific date (YYYY-MM-DD). Defaults to most recent." }, session: { type: "string", description: "Optional: AM, PM, or Full Day to target specific session" }, new_liters: { type: "number", description: "Corrected liter amount" }, notes: { type: "string", description: "Reason for correction" } }, required: ["animal_identifier"] } } },
    // Breeding update tool
    { type: "function", function: { name: "update_ai_record", description: "Update AI/breeding record. Use for confirming pregnancy ('confirmed na buntis'), setting expected delivery date, or correcting breeding info.", parameters: { type: "object", properties: { animal_identifier: { type: "string", description: "Animal name or ear tag" }, pregnancy_confirmed: { type: "boolean", description: "true=confirmed pregnant, false=not pregnant, null=unknown" }, expected_delivery_date: { type: "string", description: "Expected calving/kidding date (YYYY-MM-DD)" }, notes: { type: "string", description: "Additional notes about pregnancy/breeding" } }, required: ["animal_identifier"] } } },
    // Feeding update tool
    { type: "function", function: { name: "update_feeding_record", description: "Correct a previous feeding record. Use when feed amount or type was recorded wrong.", parameters: { type: "object", properties: { animal_identifier: { type: "string", description: "Animal name or ear tag" }, record_date: { type: "string", description: "Optional: specific date (YYYY-MM-DD). Defaults to most recent." }, new_kilograms: { type: "number", description: "Corrected feed amount in kg" }, new_feed_type: { type: "string", description: "Corrected feed type" }, notes: { type: "string", description: "Reason for correction" } }, required: ["animal_identifier"] } } },
    // Injection update tool
    { type: "function", function: { name: "update_injection_record", description: "Correct a previous injection/medication record. Use when dosage or medicine was recorded wrong.", parameters: { type: "object", properties: { animal_identifier: { type: "string", description: "Animal name or ear tag" }, record_date: { type: "string", description: "Optional: specific date (YYYY-MM-DD). Defaults to most recent." }, new_medicine_name: { type: "string", description: "Corrected medicine name" }, new_dosage: { type: "string", description: "Corrected dosage" }, notes: { type: "string", description: "Reason for correction" } }, required: ["animal_identifier"] } } },
