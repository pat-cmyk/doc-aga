-- Fix get_combined_dashboard_data: replace non-existent active_animal_count with stage_counts->>'total'
...
BEGIN
  ...
  -- FIX: Use COALESCE((stage_counts->>'total')::int, 0) instead of non-existent active_animal_count
