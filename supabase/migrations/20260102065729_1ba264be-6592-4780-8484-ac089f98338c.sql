-- Drop and recreate the get_system_health_metrics function to include sync data
...
BEGIN
  SELECT json_build_object(
    'users', json_build_object(
      ...
      'active_24h', (SELECT COUNT(DISTINCT user_id) FROM auth_events WHERE event_type = 'login' AND created_at > now() - interval '24 hours'),
